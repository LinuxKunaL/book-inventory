...
const getOverviewData = async (req, res) => {
    try {
        ...
        const result = await other_service_1.default.getOverviewData(userId);
...
const getAchievements = async (req, res) => {
    try {
        const userId = req.student.id;
        const result = await other_service_1.default.getAchievements(userId);
        res.status(http_status_codes_1.default.OK).json(result);
        return;
    }
    catch (error) {
...
exports.default = { getOverviewData, getAchievements };
