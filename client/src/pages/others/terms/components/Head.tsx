    ...
    <div className="py-16 lg:py-24 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center space-y-6 relative">
          <div className="flex items-center justify-center space-x-2 text-sm text-gray-700 dark:text-gray-400 sm:mb-8 mb-5 relative z-10">
            <Link
              to="/"
          ...
          <Grids variant="mask" />
          <h1 className="text-3xl sm:text-5xl lg:text-6xl font-bold dark:text-white text-crimson-500 leading-tight">
            Terms of Service
          </h1>
