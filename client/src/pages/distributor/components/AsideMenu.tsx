...
function AsideMenu() {
  ...
  const navigationItems = [
     {
      label: "Overview",
      href: "/distributor/overview",
      icon: MdHome,
      isActive: pathname.includes("/overview"),
    },
    {
      label: "Orders request",
      href: "/distributor/orders-request?page=1",
      icon: TbPackage,
      isActive: pathname.includes("/orders-request"),
    },
    {
      label: "Books",
      href: "/distributor/books?page=1",
      icon: MdBook,
      isActive: pathname.includes("/distributor/books"),
    },
    {
      label: "Notifications",
      href: "/distributor/notifications?page=1",
      icon: MdNotifications,
      isActive: pathname.includes("/distributor/notifications"),
    },
  ];
