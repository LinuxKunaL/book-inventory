...
export const VideoPlayerSeekBackwardButton = ({
  ...
  <MediaSeekBackwardButton className={clsx("p-0.5 sm:p-2.5", className)} {...props} />
);
...
export const VideoPlayerSeekForwardButton = ({
  ...
  <MediaSeekForwardButton className={clsx("p-0.5 sm:p-2.5", className)} {...props} />
);
...
export const VideoPlayerFullscreenButton = ({
  ...
  <MediaFullscreenButton className={clsx("p-0.5 sm:p-2.5", className)} {...props} />
);